module Line3D3NodeM
  ...
  private
  public :: Line3D3NodeDT, line3D3Node

  type, extends(GeometryDT) :: Line3D3NodeDT
   contains
  ...
  end type Line3D3NodeDT

  interface line3D3Node
     procedure :: constructor
  end interface line3D3Node

  integer(ikind), parameter :: NNODE = 3

contains

  type(Line3D3NodeDT) function constructor(gaussOrder)
    implicit none
  ...
  subroutine init(this, gaussOrder)
    implicit none
    class(Line3D3NodeDT), intent(inout) :: this
    integer(ikind)      , intent(in)    :: gaussOrder
    this%nNode = NNODE
    this%dim = 3
  ...
  function dShapeFunc(this, point)
    ...
    dShapeFunc(3,1) = 0._rkind
    dShapeFunc(3,2) = 0._rkind
    dShapeFunc(3,3) = 0._rkind
