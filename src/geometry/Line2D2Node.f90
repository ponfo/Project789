module Line2D2NodeM
  ...
  private
  public :: Line2D2NodeDT, line2D2Node
  ...
  end type Line2D2NodeDT

  interface line2D2Node
     procedure :: constructor
  end interface line2D2Node

  integer(ikind), parameter :: NNODE = 2

contains

  type(Line2D2NodeDT) function constructor(gaussOrder)
    implicit none
