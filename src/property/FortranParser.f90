...
MODULE FortranParser
  ...
  !------- -------- --------- --------- --------- --------- --------- --------- -------
  USE UtilitiesM               ! Import KIND parameters
  ...
  INTEGER(ikind),                              PARAMETER :: cImmed   = 1,          &
                                                         cNeg     = 2,          &
                                                         cAdd     = 3,          & 
                                                         cSub     = 4,          & 
                                                         cMul     = 5,          & 
  ...
  TYPE EquationParser
    ...
    INTEGER(ikind), POINTER :: ByteCode(:) => null()
    INTEGER              :: ByteCodeSize = 0
    REAL(rkind),    POINTER :: Immed(:) => null()
    INTEGER              :: ImmedSize = 0
    REAL(rkind),    POINTER :: Stack(:) => null()
    INTEGER              :: StackSize = 0
    INTEGER              :: StackPtr = 0
...
!*****************************************************************************************
  FUNCTION evaluate(this, Val) RESULT (res)
    ...
    class(EquationParser) :: this
    REAL(rkind), DIMENSION(:), INTENT(in) :: Val                ! Variable values

    REAL(rkind)                           :: res                ! Result
...
!*****************************************************************************************
  FUNCTION VariableIndex (str, Var, ibegin, inext) RESULT (n)
    ...
    CHARACTER (LEN=*), DIMENSION(:), INTENT(in) :: Var       ! Array with variable names
    INTEGER(ikind)                                 :: n         ! Index of variable
...
!*****************************************************************************************
  SUBROUTINE AddCompiledByte(this, b)
    ...
    class(EquationParser) :: this
    INTEGER(ikind), INTENT(in) :: b                             ! Value of byte to be added
...
!*****************************************************************************************
  FUNCTION MathItemIndex(this, b, e) RESULT (n)
    ...
    INTEGER(ikind)                                 :: n         ! Byte value of math item
